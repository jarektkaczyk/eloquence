...
class Builder extends HookableBuilder
{
    ...
    */
    ...
    public function hasHook($column) {
        if($this->query->getGrammar() instanceof  PostgresGrammar && $this->model->isCastable($column)) {
            return true;
        } else {
            return parent::hasHook($column); // TODO: Change the autogenerated stub
        }
    }
